...
This website is powered by [Jekyll](https://jekyllrb.com) and uses some [Bootstrap](http://www.getbootstrap.com) and  [Bootswatch](http://www.bootswatch.com). [Allan lab](https://allanlab.org) has tried to make it simple yet adaptable, so that it is easy for you to re-use it for your purpose. This website is created from [Allan lab repository](https://github.com/mpa139/allanlab).
...
You can use this template as you please.
